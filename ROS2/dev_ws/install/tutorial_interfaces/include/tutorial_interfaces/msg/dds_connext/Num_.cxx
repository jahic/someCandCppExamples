    ...
    namespace msg {
        namespace dds_ {
            ...
            DDS_TypeCode* Num__get_typecode()
            {
                ...
                static DDS_TypeCode Num__g_tc_data__sequence = DDS_INITIALIZE_SEQUENCE_TYPECODE(RTI_INT32_MAX,NULL);
                ...
                Num__g_tc_data__sequence._data._typeCode = (RTICdrTypeCode *)&DDS_g_tc_longlong;

                Num__g_tc_members[0]._representation._typeCode = (RTICdrTypeCode *)& Num__g_tc_data__sequence;
