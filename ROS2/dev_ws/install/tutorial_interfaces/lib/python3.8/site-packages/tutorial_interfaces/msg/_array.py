...
class Array(metaclass=Metaclass_Array):
    ...
    _fields_and_field_types = {
        'member': 'sequence<tutorial_interfaces/Num>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['tutorial_interfaces', 'msg'], 'Num')),  # noqa: E501
    )
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, Num) for v in value) and
                 True), \
                "The 'member' field must be a set or sequence and each value of type 'Num'"
        self._member = value
